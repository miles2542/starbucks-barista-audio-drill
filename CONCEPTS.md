...
* [`recipe-dataset-schema-management.md`](file:///x:/Programming/Python/Projects/Web%20&%20SPAs/Starbucks%20BF30%20Recipe%20v3/docs/solutions/recipe-dataset-schema-management.md) — Recipe TypeScript interface definition, explicit `sizes` array contract, and ground truth modification rules.
